    ...
    <Container>
      <PageWrapper>
        ...
        <ul className="list-disc pl-4">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Lucas Lo Portfolio.
            </p>
          </li>
          ...
          <li>
            <p>
              ...
              included or made included or made available by the Service.
            </p>
          </li>

          <li>
            <p>
              <strong>Website</strong> refers to Lucas Lo Portfolio, accessible
              from from{' '}
              <a href="https://lmlok.com/" rel="noreferrer" target="_blank">
                https://lmlok.com/
              </a>
            </p>
          </li>
        ...
        <p>
          ...
          included included thereon; (ii) that the Service will be uninterrupted
          or error-free; (iii) as to the accuracy, reliability, or currency of
          any information or content provided through the Service; or (iv) that
